...
// includes
var GenerationView = require('./js/generation-view.js')
	, MolnarEvolver = require('./js/molnar-evolver.js')
	, MolnarCanvas = require('./js/molnar-canvas.js')
...
var viewer = new GenerationView('body', {
	width: browser.width
...
var molnarCanvas = new MolnarCanvas();
